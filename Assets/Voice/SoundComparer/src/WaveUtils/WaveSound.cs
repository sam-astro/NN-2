...
namespace SoundComparer.WaveUtils
{
	...
	public class WaveSound
    {
        ...
        public List<short> fftData = new List<short>();
        ...
        {
            // Read WAV file and write FFT data
            ...
            //using (BinaryWriter fft = new BinaryWriter(File.Open(filename + ".fft.dat", FileMode.Create)))
            {
                ...
                {
                    UnityEngine.Debug.Log("The sound has " + format.BitsPerSample + " bits per sample. Please choose a sound with 8 or 16 bits per sample.");
                    return;
                }
                ...
                int di = 2; // every second, take 2205 data or every 5 data take 1 data
